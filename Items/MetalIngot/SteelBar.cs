...
namespace Galaxy.Items.MetalIngot {
    ...
    public class SteelBar : ModItem {
        ...
        public override void SetStaticDefaults() {
            ...
            // 物品中文名字
            DisplayName.AddTranslation(GameCulture.Chinese, "钢锭");

            // 物品的描述
            Tooltip.SetDefault("The material basis of modern society");
            // 物品的中文描述
            Tooltip.AddTranslation(GameCulture.Chinese, "现代社会的物质基础" );
        }
        ...
        public override void AddRecipes() {
            ...
            // 合成材料，材料的数量
            recipe.AddIngredient(null, "PureIronIngot", 3);
            recipe.AddIngredient(null, "Anthracite", 2);
            // 工作站
