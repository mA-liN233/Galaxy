...
namespace Galaxy.Items.Mineral {
    ...
    public class OilShale : ModItem {
        ...
        public override void SetStaticDefaults() {
            ...
            // 物品中文名字
            DisplayName.AddTranslation(GameCulture.Chinese, "油页岩");

            // 物品的描述
            Tooltip.SetDefault("Organic rich sedimentary rocks");
            // 物品的中文描述
            Tooltip.AddTranslation(GameCulture.Chinese, "富含有机物的沉积岩" );
        }
